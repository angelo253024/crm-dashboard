...
export default function ChatBotWidget() {
  ...
  const quickReplies = [
    { label: '💬 WhatsApp Empresa', isDirectLink: true, url: 'https://wa.me/59167750005?text=Hola%20Lavam%C3%B3vil%20Norte%2C%20quisiera%20hacer%20una%20consulta' },
  ...
  const handleQuickReply = async (reply) => {
    if (reply.isDirectLink && reply.url) {
  ...
  return (
    <>
      {/* Botón Flotante WhatsApp Oficial de la Compañía */}
      <a 
        ...
        title="Contactar por WhatsApp Oficial (+591 67750005)"
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            {/* Botón directo de WhatsApp de la compañía */}
            <a
              href="https://wa.me/59167750005?text=Hola%20Lavam%C3%B3vil%20Norte%2C%20quisiera%20hacer%20una%20consulta"
              target="_blank"
              rel="noopener noreferrer"
              ...
              onMouseEnter={e => e.currentTarget.style.transform = 'scale(1.05)'}
              onMouseLeave={e => e.currentTarget.style.transform = 'scale(1)'}
              title="Chatear por WhatsApp con Lavamóvil Norte (+591 67750005)"
            >
